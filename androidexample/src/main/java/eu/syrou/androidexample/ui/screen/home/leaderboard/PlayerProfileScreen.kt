...
import io.github.syrou.reaktiv.navigation.extension.typed
...
object PlayerProfileScreen : Screen {
    ...
    override fun Content(params: Map<String, Any>) {
        ...
        val playerProfile = params.getDecodedParam<PlayerProfile>("profile")
        println("AKLSDASD - params: $params")
        println("AKLSDASD - playerId: $playerId")
        println("AKLSDASD - playerProfile: $playerProfile")

        // If no profile data passed, create mock data (in real app, you'd fetch from API)
            ...
            item {
                Row(
                    ...
                    Button(
                        onClick = {
                            scope.launch {
                                store.navigateTypeSafe("home/leaderboard/stats/individual") {
                    ...
                    Button(
                        onClick = {
                            scope.launch {
                                store.navigateTypeSafe("home/leaderboard/stats/team") {
...
// Mock data creation functions (in real app, these would come from your data layer)
